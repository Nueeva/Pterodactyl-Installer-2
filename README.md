...
```bash
bash <(curl -s https://raw.githubusercontent.com/Nueeva/Pterodactyl-Installer-2/main/autoinstall.sh)  <fqdn> <ssl> <email> <username> <firstname <lastname> <password> <wings>
```
